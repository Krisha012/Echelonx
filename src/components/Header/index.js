...
const Navbar = () => {
    ...
    const isSticky = () => {
        ...
        const fixeclassName = scrollTop >= 120 ? "bg-black-400 border-b border-black-200 lg:transition-all lg:duration-700 lg:ease-in-out" : "lg:bg-transparent bg-black-400";

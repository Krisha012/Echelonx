        ...
        <React.Fragment>
            ...
            <section id='Home'>
                <div className='h-[615px] w-full'>
                    ...
                    <div className='bg-black-400 opacity-80 absolute w-full h-[615px] top-0 left-0'></div>
                </div>
                <div className='absolute top-0 left-0 w-full'>
                    <div className='container'>
                        <div className='grid grid-cols-1 h-[615px] justify-items-center content-center'>
